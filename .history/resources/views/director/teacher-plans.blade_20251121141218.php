...
<script>
    ...
    function handleSearchInput(input) {
        ...
        // ถ้าพิมพ์ว่างเลย (ลบจนหมด) -> ให้รีเฟรชผลลัพธ์ทั้งหมด
        if (value.length === 0) {
        ...
        // ถ้ายังพิมพ์ไม่ถึง 2 ตัวอักษร -> ยังไม่ต้องยิงค้นหา auto
        if (value.length < 2) {
            return;
        }

        // พิมพ์ตั้งแต่ 2 ตัวขึ้นไป -> auto search หลังหยุดพิมพ์ 400ms
        searchTimer = setTimeout(function () {
            input.form.submit();
        }, 400);
    }
