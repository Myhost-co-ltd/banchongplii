...
<div class="space-y-8 overflow-y-auto pr-2">
    ...
    <div class="flex flex-col gap-4">
        ...
        {{-- สถิติ: จำนวนหลักสูตร / จำนวนครูผู้สอน (ย้ายมาอยู่บนสุดแล้ว) --}}
        ...
        {{-- ฟอร์มเลือก หลักสูตร / ชั้น / ค้นหา --}}
                ...
                <div class="flex items-center gap-2 bg-white border border-gray-200 shadow-sm rounded-2xl px-4 py-2.5">
                    ...
                    <select id="course" name="course"
                        ...
                        @foreach ($courseOptions as $courseName)
                            <option value="{{ $courseName }}" {{ $courseName === $selectedCourse ? 'selected' : '' }}>
                                {{ $courseName }}
                            </option>
                        @endforeach
                    </select>
