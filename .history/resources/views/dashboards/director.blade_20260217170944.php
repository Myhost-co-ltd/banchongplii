...
<div class="space-y-10 overflow-y-auto pr-2">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-6">
        ...
        <div class="relative p-7 min-h-[220px] bg-gradient-to-br from-blue-50 to-blue-200 border border-blue-300 rounded-2xl shadow">
            <div class="pr-20">
            ...
            <p class="absolute top-7 right-7 text-4xl font-bold text-blue-800 text-right leading-none">{{ number_format($studentCount ?? 0) }}</p>
        </div>


        <div id="student-room-section" class="relative p-7 min-h-[220px] bg-gradient-to-br from-purple-50 to-purple-200 border border-purple-300 rounded-2xl shadow w-full text-left transition hover:-translate-y-0.5 hover:shadow-lg">
            <div class="pr-20">
            ...
            <p class="absolute top-7 right-7 text-4xl font-bold text-purple-800 text-right leading-none">{{ number_format($classCount ?? 0) }}</p>
         ...
         <button type="button"
                ...
                class="relative p-7 min-h-[220px] bg-gradient-to-br from-green-50 to-green-200 border border-green-300 rounded-2xl shadow w-full text-left transition hover:-translate-y-0.5 hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-green-400 focus:ring-offset-2">
            <div class="pr-20">
            ...
            <p class="absolute top-7 right-7 text-4xl font-bold text-green-800 text-right leading-none">{{ number_format($teacherCount ?? 0) }}</p>
        </button>

        <button type="button"
                data-teacher-status-target="complete"
                class="relative p-7 min-h-[220px] bg-gradient-to-br from-sky-50 to-sky-200 border border-sky-300 rounded-2xl shadow w-full text-left transition hover:-translate-y-0.5 hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-sky-400 focus:ring-offset-2">
            <div class="pr-20">
            ...
            <p class="absolute top-7 right-7 text-4xl font-bold text-sky-800 text-right leading-none">{{ number_format($completeTeacherCount ?? 0) }}</p>
        </button>

        <button type="button"
                data-teacher-status-target="incomplete"
                class="relative p-7 min-h-[220px] bg-gradient-to-br from-amber-50 to-amber-200 border border-amber-300 rounded-2xl shadow w-full text-left transition hover:-translate-y-0.5 hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-amber-400 focus:ring-offset-2">
            <div class="pr-20">
            ...
            <p class="absolute top-7 right-7 text-4xl font-bold text-amber-800 text-right leading-none">{{ number_format($incompleteTeacherCount ?? 0) }}</p>
        </button>
