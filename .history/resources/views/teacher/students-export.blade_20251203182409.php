...
<head>
    <meta charset="UTF-8">
    <style>
        /* Prefer Noto Sans Thai to ensure Thai glyphs render correctly in PDFs */
        @font-face {
            font-family: 'NotoSansThai';
            font-weight: 400;
            src: url('{{ str_replace('\\', '/', storage_path('fonts/NotoSansThai-Regular.ttf')) }}') format('truetype');
        }
        @font-face {
            font-family: 'NotoSansThai';
            font-weight: 700;
            src: url('{{ str_replace('\\', '/', storage_path('fonts/NotoSansThai-Bold.ttf')) }}') format('truetype');
        }
        @font-face {
        ...
        body { font-family: 'NotoSansThai', 'LeelawUI', 'DejaVu Sans', sans-serif; font-size: 13px; color: #1f2937; line-height: 1.6; }
