...
<div class="space-y-8 overflow-y-auto pr-2 pb-6">
    ...
    <div class="bg-white rounded-3xl shadow-md p-8 border border-gray-100 mb-2">
        ...
        {{-- เอาปุ่มออกจากตรงนี้ ไม่ให้โชว์ด้านบน --}}
        {{-- 
        <div class="mt-4 flex gap-3">
            <a href="{{ route('teacher.course-create') }}"
               class="px-4 py-2 bg-gray-200 rounded-xl text-gray-700">กลับไปหน้าสร้างหลักสูตร</a>
            <a href="{{ route('teacher.courses.edit', $course) }}"
               class="px-4 py-2 bg-blue-600 text-white rounded-xl">แก้ไขหลักสูตร</a>
        </div>
        --}}
    </div>

    {{-- กล่องรายละเอียดหลักสูตร + ปุ่มมุมขวา (ตรงวงแดง) --}}
    <div class="bg-white rounded-3xl shadow-md p-8 border border-gray-100">
        ...
        {{-- ⭐ ปุ่มย้ายมาอยู่ตรงนี้ มุมขวาล่างของกล่อง (ตำแหน่งวงแดง) --}}
        <div class="flex justify-end gap-3 mt-6">
            <a href="{{ route('teacher.course-create') }}"
               class="px-4 py-2 bg-gray-200 rounded-xl text-gray-700">
