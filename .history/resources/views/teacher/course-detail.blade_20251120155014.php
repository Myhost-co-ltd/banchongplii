    ...
    @else
        ...
        <div class="bg-white rounded-3xl shadow-md p-8 border border-gray-100">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                    ...
                    <p class="text-gray-700 mt-1 leading-relaxed">{{ $course->description ?? 'ยังไม่มีรายละเอียด' }}</p>
                </div>
            </div>
        </div>
        ...
        <form id="hourForm" method="POST" action="{{ route('teacher.courses.hours.store', $course) }}"
            ...
            <select name="unit" class="border rounded-xl px-3 py-2" required>
                ...
                <option value="ชั่วโมง/สัปดาห์">สัปดาห์</option>
            </select>
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-600">
                                ...
                                @if(!empty($assignment['due_date']))
                                    ...
                                    กำหนดส่ง: {{ \Illuminate\Support\Carbon::parse($assignment['due_date'])->locale('th')->isoFormat('D MMM YYYY') }}
                                @endif
                            </p>
        ...
        <form id="assignmentForm" method="POST" action="{{ route('teacher.courses.assignments.store', $course) }}"
            ...
            <textarea name="notes" rows="1" class="border rounded-xl px-3 py-2" placeholder="รายละเอียดงานเพิ่มเติม"></textarea>
            <div class="md:col-span-4 text-right">
